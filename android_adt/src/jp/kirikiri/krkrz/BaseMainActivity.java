...
public class BaseMainActivity extends Activity  implements SurfaceHolder.Callback/*, ExoPlayer.EventListener, ExtractorMediaSource.EventListener,
	...
	private final static boolean SHOW_TOAST = false; //show error dialog
    ...
    class ShowToastEvent implements Runnable {
        ...
        public void run() {
        	if (SHOW_TOAST) {
        		...
        		Dialog dialog2;
        		dialog2 = new AlertDialog.Builder(BaseMainActivity.this)
        			...
        			.create();
        		final AlertDialog adlg = (AlertDialog)dialog2;
